<div class="container">
    <!-- Sign up form -->
    <form action="{{ route('data.update', $urun->id) }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <!-- Sign up card -->
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-3">
                        <label class="col-12">Sektör</label>

                        <select name="sektor" class="form-control" required>
                            <option value="">Sekttör Seçiniz</option>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input id="" type="number" min="1" step="any" class="form-control fiyat"
                            value="{{ str_replace(',', '', $urun->fiyat) }}" name="fiyat" required>
                    </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        // if ({{ $urun->sektor }} != "" && {{ $urun->sektor }} != null) {
        //     $("#kategori").val({{ $urun->sektor }});
